...
Loan rejected: The company had rejected the loan (because the candidate does not meet their requirements etc.). So, there is no transactional history of such applicants and thus this data is not available with the company.
...
If one is able to identify these risky loan applicants, such loans can be reduced thereby cutting down the amount of credit loss. Identification of such applicants using EDA is the aim of this case study.
